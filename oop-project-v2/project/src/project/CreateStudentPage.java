...
public class CreateStudentPage extends JFrame implements ActionListener {
     JButton  Ok,Return;
...
public CreateStudentPage()
{
    ...
    //data from user stored in create student method parameters
        Ok=new JButton();
        Return=new JButton();
...
if(ae.getSource()==Ok){
  ...
  returnedEmail=  System_Operations.Create_student(ID.getText(), firstName.getText(), LastName.getText(), Phone.getText(),
            Integer.parseInt(y),Integer.parseInt(l), p);
  
   JOptionPane.showMessageDialog(this,returnedEmail, "info",JOptionPane.INFORMATION_MESSAGE);
this.dispose();
